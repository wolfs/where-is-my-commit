...
!function () {
    ...
    function J(n, e) {
        ...
        if (r.createSVGPoint) {
            ...
            return Na ? (u.x = e.pageX, u.y = e.pageY) : (u.x = e.clientX, u.y = e.clientY), u = u.matrixTransform(n.getScreenCTM().inverse()), [
                u.x,
                u.y
            ];
        }
    ...
    function ct(n, t, e) {
        ...
        var i, o;
        return n = isNaN(n) ? 0 : (n %= 360) < 0 ? n + 360 : n, t = isNaN(t) ? 0 : 0 > t ? 0 : t > 1 ? 1 : t, e = 0 > e ? 0 : e > 1 ? 1 : e, o = 0.5 >= e ? e * (1 + t) : e + t - e * t, i = 2 * e - o, new mt(u(n + 120), u(n), u(n - 120));
    }
    function lt(n, t, e) {
    ...
    function ht(n, t, e) {
        ...
        return u = pt(u) * Xa, r = pt(r) * $a, i = pt(i) * Ba, new mt(dt(3.2404542 * u - 1.5371385 * r - 0.4985314 * i), dt(-0.969266 * u + 1.8760108 * r + 0.041556 * i), dt(0.0556434 * u - 0.2040259 * r + 1.0572252 * i));
    }
    function gt(n, t, e) {
    ...
    function _t(n, t, e) {
        ...
        return a ? (u = 0.5 > c ? a / (o + i) : a / (2 - o - i), r = n == o ? (t - e) / a + (e > t ? 6 : 0) : t == o ? (e - n) / a + 2 : (n - t) / a + 4, r *= 60) : (r = 0 / 0, u = c > 0 && 1 > c ? 0 : r), new at(r, u, c);
    }
    function wt(n, t, e) {
        n = St(n), t = St(t), e = St(e);
        var r = vt((0.4124564 * n + 0.3575761 * t + 0.1804375 * e) / Xa), u = vt((0.2126729 * n + 0.7151522 * t + 0.072175 * e) / $a), i = vt((0.0193339 * n + 0.119192 * t + 0.9503041 * e) / Ba);
    ...
    function He(n) {
            ...
            return {
                ...
                point: function (f, h) {
                    var g, p = [
                            f,
                            h
                        ], v = t(f, h), d = o ? v ? 0 : u(f, h) : v ? u(f + (0 > f ? qa : -qa), h) : 0;
        ...
        function r(n, t, e) {
            var r = pe(n), u = pe(t), o = [
                    ...
                    0,
                    0
                ], a = de(r, u), c = ve(a, a), l = a[0], s = c - l * l;
            if (!s)
                return !e && n;
    ...
    function Ye(n) {
        ...
        return u.parallels = function (n) {
            return arguments.length ? r(t = n[0] * qa / 180, e = n[1] * qa / 180) : [
                t / qa * 180,
                e / qa * 180
            ];
        }, u;
    ...
    function nr(n) {
        ...
        function u(t, e, r, a, c, l, s, f, h, g, p, v, d, m) {
            ...
            if (x > 4 * i && d--) {
                ...
                (L * L / x > i || ga((y * z + M * q) / x - 0.5) > 0.3 || o > a * g + c * p + l * v) && (u(t, e, r, a, c, l, N, C, E, b /= S, _ /= S, w, d, m), m.point(N, C), u(N, C, E, b, _, w, s, f, h, g, p, v, d, m));
            }
        }
        var i = 0.5, o = Math.cos(30 * Da), a = 16;
    ...
    function ir(n) {
        ...
        return t.stream = function (n) {
            ...
            return arguments.length ? (v = n[0] % 360 * Da, d = n[1] % 360 * Da, r()) : [
                v * Pa,
                d * Pa
            ];
        }, t.rotate = function (n) {
            return arguments.length ? (m = n[0] % 360 * Da, M = n[1] % 360 * Da, x = n.length > 2 ? n[2] % 360 * Da : 0, r()) : [
                m * Pa,
                M * Pa,
                x * Pa
            ];
    ...
    function Cu(n, t) {
        var e;
        return arguments.length < 2 && (t = 0.45), arguments.length ? e = t / La * Math.asin(1 / n) : (n = 1, e = t / 4), function (r) {
    ...
    function Pu(n) {
        var t = [
                ...
                n.c,
                n.d
            ], r = ju(t), u = Uu(t, e), i = ju(Fu(e, t, -u)) || 0;
        t[0] * e[1] < e[0] * t[1] && (t[0] *= -1, t[1] *= -1, r *= -1, u *= -1), this.rotate = (r ? Math.atan2(t[1], t[0]) : Math.atan2(-e[0], e[1])) * Pa, this.translate = [
            n.e,
            n.f
        ], this.scale = [
            r,
    ...
    function ho(n) {
        ...
        var e = Ar, r = Nr, u = Ne, i = go, o = i.key, a = 0.7;
    ...
    function Do(n) {
        ...
        var e = Ar, r = Ar, u = 0, i = Nr, o = Ne, a = go, c = a.key, l = a, s = 'L', f = 0.7;
        return t.x = function (n) {
    ...
    function Io(n) {
        return function () {
            var t, e;
            (t = this[n]) && (e = t[t.active]) && (--t.count ? delete t[t.active] : delete this[n], t.active += 0.5, e.event && e.event.interrupt.call(this, this.__data__, e.index));
        };
    }
    function Yo(n, t, e) {
    ...
    var Ca = 0.000001, za = Ca * Ca, qa = Math.PI, La = 2 * qa, Ta = La - Ca, Ra = qa / 2, Da = qa / 180, Pa = 180 / qa, Ua = Math.SQRT2, ja = 2, Fa = 4;
    ta.interpolateZoom = function (n, t) {
        ...
        function g() {
            ...
            y ? clearTimeout(y) : (v = e(d = m || ta.mouse(this)), Dl.call(this), c(n)), y = setTimeout(function () {
                y = null, s(n);
            }, 50), S(), u(Math.pow(2, 0.002 * Ha()) * k.k), i(d, v), l(n);
        }
        function p() {
        ...
        var v, d, m, y, M, x, b, _, w, k = {
                ...
                960,
                500
            ], N = Ia, C = 250, z = 0, q = 'mousedown.zoom', L = 'mousemove.zoom', T = 'mouseup.zoom', R = 'touchstart.zoom', D = E(n, 'zoomstart', 'zoom', 'zoomend');
        return Oa || (Oa = 'onwheel' in ua ? (Ha = function () {
            ...
            n.each(function () {
                ...
                Tl ? ta.select(this).transition().each('start.zoom', function () {
                    ...
                    var e = A[0], r = A[1], u = d ? d[0] : e / 2, i = d ? d[1] : r / 2, o = ta.interpolateZoom([
                            (u - k.x) / k.k,
                            (i - k.y) / k.k,
                            e / k.k
                        ], [
            ...
            return arguments.length ? (N = null == t ? Ia : [
                +t[0],
                +t[1]
            ], n) : N;
        }, n.center = function (t) {
    ...
    var Va = 18, Xa = 0.95047, $a = 1, Ba = 1.08883, Wa = ft.prototype = new ot();
    ...
    ta.geo.clipExtent = function () {
        ...
        return ta.geo.conicEqualArea().rotate([
            96,
            0
        ]).center([
            -0.6,
        ...
        var t, e, r, u, i = ta.geo.albers(), o = ta.geo.conicEqualArea().rotate([
                154,
                0
            ]).center([
                -2,
                ...
                55,
                65
            ]), a = ta.geo.conicEqualArea().rotate([
                157,
                0
            ]).center([
                -3,
    ...
    ta.geo.path = function () {
        ...
        return n.area = function (n) {
            ...
            return _c = wc = Sc = kc = Ec = Ac = Nc = Cc = zc = 0, ta.geo.stream(n, u(Ic)), zc ? [
                Nc / zc,
                Cc / zc
            ] : Ac ? [
                kc / Ac,
        ...
        return n ? t(n) : (t.links = function (n) {
            ...
            return iu(e(n)).cells.forEach(function (e, r) {
                for (var u, i, o = e.site, a = e.edges.sort(Yr), c = -1, l = a.length, s = a[l - 1].edge, f = s.l === o ? s.r : s.l; ++c < l;)
                    u = s, i = f, s = a[c].edge, f = s.l === o ? s.r : s.l, r < i.i && r < f.i && au(o, i, f) < 0 && t.push([
                        n[r],
                        n[i.i],
                        n[f.i]
                    ]);
    ...
    ta.interpolateTransform = Hu, ta.layout = {}, ta.layout.bundle = function () {
        ...
        var e, r, u, i, o, a = {}, c = ta.dispatch('start', 'tick', 'end'), l = [
                1,
                1
            ], s = 0.9, f = fl, h = hl, g = -30, p = gl, v = 0.1, d = 0.64, m = [], M = [];
    ...
    ta.layout.histogram = function () {
        ...
        var t, e = ta.layout.hierarchy().sort(vi), r = 0, u = [
                1,
                1
            ];
        ...
        var o = ta.layout.hierarchy().sort(null).value(null), a = Si, c = [
                1,
                1
            ], l = null;
        ...
        var t = ta.layout.hierarchy().sort(null).value(null), e = Si, r = [
                1,
                1
            ], u = !1;
        return n.separation = function (t) {
        ...
        var o, a = ta.layout.hierarchy(), c = Math.round, l = [
                1,
                1
            ], s = null, f = Ri, h = !1, g = 'squarify', p = 0.5 * (1 + Math.sqrt(5));
        return i.size = function (n) {
            return arguments.length ? (l = n, i) : l;
        }, i.padding = function (n) {
            function t(t) {
                var e = n.call(i, t, t.depth);
                return null == e ? Ri(t) : Di(t, 'number' == typeof e ? [
                    e,
                    e,
                    e,
                    e
            ...
            if (!arguments.length)
                return s;
            var r;
            return f = null == (s = n) ? Ri : 'function' == (r = typeof n) ? t : 'number' === r ? (n = [
                n,
                n,
                n,
                n
    ...
    ta.scale.log = function () {
        return Ji(ta.scale.linear().domain([
            0,
            1
        ]), 10, !0, [
            1,
        ...
        function n() {
            ...
            if ((p = Math.min(Math.abs(l - n) / 2, +u.apply(this, arguments))) > 0.001) {
                ...
                var T = null == S ? [
                        ...
                        _,
                        w
                    ]), R = y - T[0], D = M - T[1], P = x - T[0], U = b - T[1], j = 1 / Math.sin(Math.acos((R * P + D * U) / (Math.sqrt(R * R + D * D) * Math.sqrt(P * P + U * U))) / 2), F = Math.sqrt(T[0] * T[0] + T[1] * T[1]);
                if (null != x) {
                    var H = Math.min(p, (l - F) / (j + 1)), O = fo(null == S ? [
                            _,
                            w
                        ] : [
                            S,
    ...
    ta.svg.brush = function () {
        ...
        function i() {
            ...
            function d() {
                ...
                x && (n[0] += x[0], n[1] += x[1]), C || (ta.event.altKey ? (M || (M = [
                    (f[0] + f[1]) / 2,
                    (h[0] + h[1]) / 2
                ]), q[0] = f[+(n[0] < M[0])], q[1] = h[+(n[1] < M[1])]) : M = null), A && m(n, l, 0) && (r(k), t = !0), N && m(n, s, 1) && (u(k), t = !0), t && (e(k), w({
                    type: 'brush',
                    mode: C ? 'move' : 'resize'
                }));
            }
        ...
        var o, a, c = E(n, 'brushstart', 'brush', 'brushend'), l = null, s = null, f = [
                0,
                0
            ], h = [
                0,
        ...
        return n.event = function (n) {
            ...
            return arguments.length ? (l && s ? (g = !!t[0], p = !!t[1]) : l ? g = !!t : s && (p = !!t), n) : l && s ? [
                g,
                p
            ] : l ? g : s ? p : null;
        }, n.extent = function (t) {
            var e, r, u, i, c;
            return arguments.length ? (l && (e = t[0], r = t[1], s && (e = e[0], r = r[0]), o = [
                e,
                r
            ], l.invert && (e = l(e), r = l(r)), e > r && (c = e, e = r, r = c), (e != f[0] || r != f[1]) && (f = [
                e,
                r
            ])), s && (u = t[0], i = t[1], l && (u = u[1], i = i[1]), a = [
                u,
                i
            ], s.invert && (u = s(u), i = s(i)), u > i && (c = u, u = i, i = c), (u != h[0] || i != h[1]) && (h = [
                u,
                i
            ])), n) : (l && (o ? (e = o[0], r = o[1]) : (e = f[0], r = f[1], l.invert && (e = l.invert(e), r = l.invert(r)), e > r && (c = e, e = r, r = c))), s && (a ? (u = a[0], i = a[1]) : (u = h[0], i = h[1], s.invert && (u = s.invert(u), i = s.invert(i)), u > i && (c = u, u = i, i = c))), l && s ? [
                [
                    e,
                    u
                ],
    ...
    var Hl = {
            ...
            []
        ], Il = ac.format = gc.timeFormat, Yl = Il.utc, Zl = Yl('%Y-%m-%dT%H:%M:%S.%LZ');
    Il.iso = Date.prototype.toISOString && +new Date('2000-01-01T00:00:00.000Z') ? Jo : Zl, Jo.parse = function (n) {
        ...
        return new cc(1000 * Math.floor(n / 1000));
    }, function (n, t) {
        ...
        return new cc(60000 * Math.floor(n / 60000));
    }, function (n, t) {
        ...
        return new cc(3600000 * (Math.floor(n / 3600000 - t) + t));
    }, function (n, t) {
    ...
    }), 'function' == typeof define && define.amd ? define('d3', [], ta) : 'object' == typeof module && module.exports && (module.exports = ta), this.d3 = ta;
}();
